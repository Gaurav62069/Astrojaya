...
const About = () => {
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4">
      ...
      <div className="max-w-7xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-slate-900 p-8 rounded-2xl border border-slate-800 text-center hover:border-amber-500/50 transition-colors">
      ...
      <div className="max-w-7xl mx-auto bg-slate-900 rounded-3xl overflow-hidden border border-slate-800">
